...
import { debounce, get, isEqual, set } from "es-toolkit/compat";
...
*/
function updateCSSVariables(variables, id = "__vben-styles__", selector = ":root") {
